...
| [BLARK 1.0](https://www.maltokni.fo/en/resource/ravnur-blark-1-0/) (background corpus) ([Simonsen ea 2022](https://aclanthology.org/2022.lrec-1.495/)) | | 25M tokens | Faroese ortho | CC BY 4.0 |
...
| [BLARK 1.0](https://www.maltokni.fo/en/resource/ravnur-blark-1-0/) (audio) ([Simonsen ea 2022](https://aclanthology.org/2022.lrec-1.495/)) | locations (Suðuroy, Sandoy, Suðurstreymoy, Norðurstreymoy/​Eysturoy, Vágar, Norðuroyggjar) | 100 hrs | audio, Faroese ortho, some phono | CC BY 4.0 |
...
| [ITU Faroese/Danish](https://huggingface.co/datasets/strombergnlp/itu_faroese_danish) ([Derczynski ea 2022](https://arxiv.org/abs/2206.08727)) | Danish translations; overlaps with (Danish) Tatoeba | 4k sentences | | CC BY 4.0 |
...
| [UDHR-LID](https://huggingface.co/datasets/cis-lmu/udhr-lid) (subset) ([Karagan ea 2023](https://arxiv.org/abs/2310.16248), [Unicode](https://www.unicode.org/udhr/)) | | 57 sentences |  | CC0 1.0 |
| [OpenLID](https://github.com/laurieburchell/open-lid-dataset) (subset) ([Burchell ea 2023](https://aclanthology.org/2023.acl-short.75/)) | combines other corpora | 40k lines | | [depend on source datasets](https://github.com/laurieburchell/open-lid-dataset/blob/main/licenses.md) |
| [FAO News 2020](https://corpora.uni-leipzig.de/en?corpusId=fao_news_2020) ([Goldhahn ea 2012](https://aclanthology.org/L12-1154/)) | uncurated? | 33.8k sentences |  | ? |
| [FAO Newscrawl 2011](https://corpora.uni-leipzig.de/en?corpusId=fao_newscrawl_2011) ([Goldhahn ea 2012](https://aclanthology.org/L12-1154/)) | uncurated? | 8.8k sentences |  | ? |
| [Faroese Mixed Corpus](https://wortschatz.uni-leipzig.de/en/download/Faroese) ([Goldhahn ea 2012](https://aclanthology.org/L12-1154/)) | uncurated? | 300k sentences |  | ? |
| [Faroese Web Corpus](https://wortschatz.uni-leipzig.de/en/download/Faroese) ([Goldhahn ea 2012](https://aclanthology.org/L12-1154/)) | uncurated? | 1M sentences |  | ? |
...
For additional resources/tools, see also the [resource list of the Faroese Centre for Language Technology](https://www.maltokni.fo/en/tilfeingi/).
...
| [UD Norwegian Nynorsk LIA](https://github.com/UniversalDependencies/UD_Norwegian-NynorskLIA) ([+transcriptions](https://tekstlab.uio.no/LIA/norsk/index_english.html)) ([Øvrelid ea 2018](https://aclanthology.org/L18-1710/)) | POS (UPOS), dependencies (UD), morpho (UD), lemmas, locations (10 places in Norway). Annotated subset of *LIA Norsk* | 5.3k speech segments / 55k tokens | [Nynorsk ortho](https://tekstlab.uio.no/LIA/pdf/rettleiing-translitterator.pdf), [phono](https://tekstlab.uio.no/LIA/pdf/transkripsjonsrettleiing_lia.pdf); aligned Nynorsk+phono [here](https://github.com/mainlp/UD_Norwegian-NynorskLIA_dialect) ([Blaschke ea 2023](https://aclanthology.org/2023.vardial-1.5/)) | [treebank: CC BY-SA 4.0](https://github.com/UniversalDependencies/UD_Norwegian-NynorskLIA/blob/master/LICENSE.txt), [transcriptions: CC BY-NC-SA 4.0](https://tekstlab.uio.no/LIA/norsk/index_english.html) |
...
| [NoMusic](https://github.com/ltgoslo/NoMusic) ([Mæhlum & Scherrer 2024](https://aclanthology.org/2024.vardial-1.9/)) subset of [xSID](https://github.com/mainlp/xsid) | slot filling, intent detection, translations into Bokmål and 20+ other languages; location (8 dialects) | 8×800 sentences | ad-hoc pronunciation spelling | [CC BY-SA 4.0](https://github.com/mainlp/xsid/blob/main/LICENSE) |
...
| [Nordic Dialect Corpus](http://tekstlab.uio.no/nota/scandiasyn/) (subset) ([Johannessen ea 2009](https://aclanthology.org/W09-4612/)) | locations (>100 places) | 1.9M tokens | Bokmål ortho, [phono](http://www.tekstlab.uio.no/scandiasyn/Transkripsjonsrettleiing%20for%20ScanDiaSyn.pdf); aligned Bokmål+phono [here](https://github.com/Helsinki-NLP/ndc-aligned/tree/main) ([Scherrer 2023](https://aclanthology.org/2023.sigmorphon-1.12/)) | [CC BY-NC-SA 4.0](http://www.tekstlab.uio.no/scandiasyn/download.html) |
...
| [UDHR-LID](https://huggingface.co/datasets/cis-lmu/udhr-lid) (subset) ([Karagan ea 2023](https://arxiv.org/abs/2310.16248), [Unicode](https://www.unicode.org/udhr/)) | | 58 sentences |  | CC0 1.0 |
...
| [UDHR-LID](https://huggingface.co/datasets/cis-lmu/udhr-lid) (subset) ([Karagan ea 2023](https://arxiv.org/abs/2310.16248), [Unicode](https://www.unicode.org/udhr/)) | | 58 sentences |  | CC0 1.0 |
| [FRY News 2020](https://corpora.uni-leipzig.de/en?corpusId=fry_news_2020) ([Goldhahn ea 2012](https://aclanthology.org/L12-1154/)) | uncurated? | 107.5k sentences | ? (written) | ? |
| [Western Frisian Newscrawl](https://wortschatz.uni-leipzig.de/en/download/Western%20Frisian) ([Goldhahn ea 2012](https://aclanthology.org/L12-1154/)) | uncurated? | 100k sentences |  |  |
...
| Corpus | Notes | Size | Representation | License |
|--------|-------|------|----------------|---------|
| [UD Low Saxon LSDC](https://github.com/UniversalDependencies/UD_Low_Saxon-LSDC) ([Siewert & Rueter 2024](https://aclanthology.org/2024.lrec-main.1388/)) | POS (UPOS), dependencies (UD), morphological features (UD), glosses (Middle Low Saxon), lemmas, locations (18 dialect areas, see also *LSDC* note); overlaps with *LSDC* | 1000 sentences | ad-hoc spelling, Nysassiske Sryvwyse | [CC BY-SA 4.0](https://github.com/UniversalDependencies/UD_Low_Saxon-LSDC/blob/master/LICENSE.txt) |
...
| [VLS Community 2017](https://corpora.uni-leipzig.de/en?corpusId=vls_community_2017) ([Goldhahn ea 2012](https://aclanthology.org/L12-1154/)) | possibly uncurated | 36.4k sentences | ? (written) | ? |
...
| Corpus | Notes | Size | Representation | License |
|--------|-------|------|----------------|---------|
| [UD Luxembourgish LuxBank](https://github.com/UniversalDependencies/UD_Luxembourgish-LuxBank/tree/master) ([Plum ea 2024](https://arxiv.org/pdf/2411.04813)) | POS tags (UPOS), dependencies (UD) | 20 sentences | Luxembourgish ortho |
...
| Luxembourgish news classification ([Lothritz ea 2022](https://aclanthology.org/2022.lrec-1.543/)) ([contact authors](https://github.com/Trustworthy-Software/LuxemBERT)) | news classification (8 classes) | 10k articles | Luxembourgish ortho | ? |
| [SIB-200](https://huggingface.co/datasets/Davlan/sib200/viewer/ltz_Latn) ([Adelani ea 2024](https://aclanthology.org/2024.eacl-long.14/)), ltz_Latn subset | topic identification (7 classes) | 1k sentences | Luxembourgish ortho | CC BY-SA 4.0 |
| SA1 ([Lothritz ea 2023](https://orbilu.uni.lu/handle/10993/55778); contact authors) | sentiment | 1.8k sentences | | |
| [Luxembourgish sentence negation](https://github.com/Trustworthy-Software/LuxemBERT) ([Lothritz ea 2023](https://orbilu.uni.lu/handle/10993/55778)) | position of negation particle; overlaps with Leipzig corpora (Newscrawl and/or Web and/or Wikipedia) | 46k sentences | | |
...
| [FLEURS](https://huggingface.co/datasets/google/fleurs) (subset) ([Conneau ea 2023](https://ieeexplore.ieee.org/document/10023141)) | parallel with ~100 languages; audio version of FLORES ([Goyal ea 2022](https://direct.mit.edu/tacl/article/doi/10.1162/tacl_a_00474/110993/The-Flores-101-Evaluation-Benchmark-for-Low)) | 1-3 recordings each of 1.9k sentences (3.8k recordings total) | audio, Luxembourgish ortho | CC BY 4.0 |
...
| [UDHR-LID](https://huggingface.co/datasets/cis-lmu/udhr-lid) (subset) ([Karagan ea 2023](https://arxiv.org/abs/2310.16248), [Unicode](https://www.unicode.org/udhr/)) | | 59 sentences |  | CC0 1.0 |
| [OpenLID](https://github.com/laurieburchell/open-lid-dataset) (subset) ([Burchell ea 2023](https://aclanthology.org/2023.acl-short.75/)) | combines other corpora | 37.7k lines | | [depend on source datasets](https://github.com/laurieburchell/open-lid-dataset/blob/main/licenses.md) |
| [Luxembourgish Newscrawl](https://wortschatz.uni-leipzig.de/en/download/Luxembourgish) ([Goldhahn ea 2012](https://aclanthology.org/L12-1154/)) | uncurated? | 300k sentences | |
| [Luxembourgish Web Corpus](https://wortschatz.uni-leipzig.de/en/download/Luxembourgish) ([Goldhahn ea 2012](https://aclanthology.org/L12-1154/)) | uncurated? | 1M sentences | |
...
| [OpenLID](https://github.com/laurieburchell/open-lid-dataset) (subset) ([Burchell ea 2023](https://aclanthology.org/2023.acl-short.75/)) | combines other corpora | 48k lines | | [depend on source datasets](https://github.com/laurieburchell/open-lid-dataset/blob/main/licenses.md) |
| [LIM Community 2017](https://corpora.uni-leipzig.de/en?corpusId=lim_community_2017) ([Goldhahn ea 2012](https://aclanthology.org/L12-1154/)) | possibly uncurated | 84.4k sentences | ? (written) | ? |
| [LIM Web 2010 (Netherlands)](https://corpora.uni-leipzig.de/en?corpusId=lim-nl_web_2019) ([Goldhahn ea 2012](https://aclanthology.org/L12-1154/)) | uncurated? | 35.4k sentences | ? (written) | ? |
...
| Corpus | Notes | Size | Representation | License |
|--------|-------|------|----------------|---------|
| [Thorsten-Voice Dataset 2023.09 Hessisch (Müller & Kreutz 2024)](https://zenodo.org/records/10511260) | Hessian | 2 hrs / 2.1k sentences | audio, German ortho | CC0 |
...
| [UDHR-LID](https://huggingface.co/datasets/cis-lmu/udhr-lid) (subset) ([Karagan ea 2023](https://arxiv.org/abs/2310.16248), [Unicode](https://www.unicode.org/udhr/)) | Eastern Yiddish | 59 sentences |  | CC0 1.0 |
| [OpenLID](https://github.com/laurieburchell/open-lid-dataset) (subset) ([Burchell ea 2023](https://aclanthology.org/2023.acl-short.75/)) | combines other corpora; Eastern Yiddish | 911 lines | | [depend on source datasets](https://github.com/laurieburchell/open-lid-dataset/blob/main/licenses.md) |
| [YDD Community 2017](https://corpora.uni-leipzig.de/en?corpusId=ydd_community_2017) ([Goldhahn ea 2012](https://aclanthology.org/L12-1154/)) | Eastern Yiddish; possibly uncurated | 21.8k sentences | ? (written) | ? |
...
| Corpus | Notes | Size | Representation | License |
|--------|-------|------|----------------|---------|
| [UD Bavarian MaiBaam](https://github.com/UniversalDependencies/UD_Bavarian-MaiBaam) ([Blaschke ea, 2024](https://aclanthology.org/2024.lrec-main.953/)) | POS (UPOS), dependencies (UD), German lemmas; dialect/location information; overlaps with wiki, xSID, NaLiBaSID | 1k sentences | ad-hoc pronunciation spelling | [CC BY-SA 4.0](https://github.com/UniversalDependencies/UD_Bavarian-MaiBaam/blob/master/LICENSE.txt) |
| [Kontatto](https://kontatti.projects.unibz.it/) ([Dal Negro & Ciccolone 2020](https://www.degruyter.com/document/doi/10.1515/soci-2020-0014/html)) | POS (unknown), lemmas (German). South Tyrolean | 147k tokens | audio, phono | [custom](https://kontatti.projects.unibz.it/what-is-kontatti/conditions-of-use/) |
| [BarNER](https://github.com/mainlp/BarNER) ([Peng ea 2024](https://aclanthology.org/2024.lrec-main.1262/)) | named entities ([based on CoNLL2003](https://github.com/mainlp/BarNER/blob/main/MaiNLP_NER_Annotation_Guidelines.pdf)); overlaps with wiki | 11k sentences | ad-hoc pronunciation spelling | [CC-BY 4.0](https://aclanthology.org/2024.lrec-main.1262.pdf#page=16) | 
| [xSID](https://github.com/mainlp/xsid) (de-st, de-ba, de-muc subsets) ([van der Goot ea 2021](https://aclanthology.org/2021.naacl-main.197/); [Winkler ea 2024](https://aclanthology.org/2024.lrec-main.1297/); [Krückl ea 2025](https://aclanthology.org/2025.vardial-1.10/)) | slot filling, intent detection, parallel with 20+ languages; South Bavarian (South Tyrol), Central Bavarian (Upper Bavaria, Munich) | 2×800 sentences | ad-hoc pronunciation spelling | [CC BY-SA 4.0](https://github.com/mainlp/xsid/blob/main/LICENSE) |
| [NaLiBaSID MAS:de-ba](https://github.com/mainlp/NaLiBaSID) ([Winkler ea 2024](https://aclanthology.org/2024.lrec-main.1297/)) | slot filling, intent detection; Central Bavarian; translation of [MASSIVE](https://aclanthology.org/2023.acl-long.235/) hence parallel with 50+ other languages| 2k sentences | ad-hoc pronunciation spelling | |
| [NaLiBaSID nat:de-ba](https://github.com/mainlp/NaLiBaSID) ([Winkler ea 2024](https://aclanthology.org/2024.lrec-main.1297/)) | slot filling, intent detection| 315 sentences | ad-hoc pronunciation spelling | |
...
| [Bavarian FineWeb2](https://huggingface.co/datasets/cis-lmu/bar-fineweb) | uncurated web data with automatic language ID | 89k articles |  | ODC-By 1.0 |
...
| Corpus | Notes | Size | Representation | License |
|--------|-------|------|----------------|---------|
| [Annotated Corpus for the Alsatian Dialects](https://zenodo.org/records/10132307) (Bernhard ea [2018](https://hal.science/hal-01704806), [2019](https://zenodo.org/record/2536041)) | POS (UPOS, mod. UPOS), lemmas, glosses (French), NEs (locations); Alsatian; overlap with Wikipedia | 798 sentences | ad-hoc pronunciation spelling | CC BY-SA 4.0 |
...
| [xSID](https://github.com/mainlp/xsid) ([Aepli ea 2023](https://aclanthology.org/2023.vardial-1.25/)) (gsw subset) | slot filling, intent detection, translations into 20+ languages. Bernese | 800 sentences | | |
...
| [Swiss German NTREX](https://github.com/textshuttle/dialect_eval) ([Aepli ea 2023](https://aclanthology.org/2023.wmt-1.99/)) | Bern, Zurich. Parallel with [129 languages](https://github.com/MicrosoftTranslator/NTREX) | 2 x 2k sents | | [CC BY-SA 4.0](https://aclanthology.org/2023.wmt-1.99.pdf) |
...
| [anko Schweizerdeutsch](https://www.ds.uzh.ch/de/projekte/ansichtskartenprojekt/korpus.html) (subset of the [Picture postcard corpus](https://clarin-ch.ch/resources/uzh)) ([Sugisaki ea 2023](https://www.transcript-open.de/doi/10.14361/9783839466346-004)) | discourse-related text spans | 600 postcards | pronunciation spelling | ? |
...
| [Schweizerdeutsches Mundartkorpus (CHMK; downloadable subcorpus)](https://chmk.ch/de/info_all) ([Weibel & Peter 2020](https://ceur-ws.org/Vol-2624/paper4.pdf)) | locations | ? | | CC BY-SA 4.0 |
...
| [STT4SG-350](https://swissnlp.org/datasets/) ([Plüss ea 2023](https://aclanthology.org/2023.acl-short.150/)) | locations (7 regions) | 343 hrs | audio, German ortho; automatic(!) dialectal transcriptions via [STT2SG-350-ASR](https://swissnlp.org/home/activities/datasets/) ([Pilz & Schneider](https://swissnlp.org/wp2020/wp-content/uploads/2025/09/STT4SG-350ASR-Transcribed_SwissGerman.pdf)) | META-SHARE NonCommercial NoRedistribution |
...
| [SwissGPC](https://github.com/stucksam/SwissGPC) ([Stucki ea 2025a](https://www.isca-archive.org/interspeech_2025/stucki25_interspeech.html), [2025b](https://arxiv.org/abs/2509.19866)) | pipeline for reconstructing the corpus | | 5.4h | audio | |
...
| SRB-300 ([D'Intino & Hutter 2025](https://link.springer.com/chapter/10.1007/978-3-031-93429-2_20)) (contact eurospider.com) | | 300h | audio, German ortho | |
...
| [Swiss German Web Corpus](https://wortschatz.uni-leipzig.de/en/download/Swiss%20German) ([Goldhahn ea 2012](https://aclanthology.org/L12-1154/)) | uncurated? | 100+k sentences |  | ? |
