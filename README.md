...
| Corpus | Notes | Size | Representation | License |
|--------|-------|------|----------------|---------|
| [Annotated Corpus for the Alsatian Dialects](https://zenodo.org/records/10132307) (Bernhard ea [2018](https://hal.science/hal-01704806), [2019](https://zenodo.org/record/2536041)) | POS (UPOS, mod. UPOS), lemmas, glosses (French); Alsatian; overlap with Wikipedia | 798 sentences | ad-hoc pronunciation spelling | CC BY-SA 4.0 |
