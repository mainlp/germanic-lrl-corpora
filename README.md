...
| [Nordic Dialect Corpus](http://tekstlab.uio.no/nota/scandiasyn/) (subset) ([Johannessen ea 2009](https://aclanthology.org/W09-4612/)) | locations (>100 places). Aligned version (ortho+phono) [here](https://github.com/Helsinki-NLP/ndc-aligned/tree/main) (publication to come) | 1.9M tokens | Bokmål ortho, [phono](http://www.tekstlab.uio.no/scandiasyn/Transkripsjonsrettleiing%20for%20ScanDiaSyn.pdf) | [CC BY-NC-SA 4.0](http://www.tekstlab.uio.no/scandiasyn/download.html) |
